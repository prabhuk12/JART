			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						...
						<t hangText="color">This is a CSS color (like "${symbol_pound}FF0000" or "red"), based on <xref target="W3C.CR-CSS21-20070719">CSS 2.1</xref>.</t>
						<t hangText="style">This is a CSS style definition (like "color: red; background-color:${symbol_pound}FFF"), based on <xref target="W3C.CR-CSS21-20070719">CSS 2.1</xref>.</t>
...
<![CDATA[
{
	...
	"extends": {"${symbol_dollar}ref": "person"}
}
]]>
						</artwork>
					</figure>
...
<![CDATA[
{
	...
	"extends": {"${symbol_dollar}ref": "http://json-schema.org/draft-03/schema"}
}
]]>
						</artwork>
					</figure>
			...
			<section title="id">
				<t>
					...
					is also used to construct relative references such as for ${symbol_dollar}ref.
				</t>
			</section>
			
			<section title="${symbol_dollar}ref">
				<t>
			...
			<section title="${symbol_dollar}schema">
				<t>
			...
			<section title="fragmentResolution">
				...
				<section title="slash-delimited fragment resolution">
					<t>
						...
						are delimited by the "/" character (${symbol_escape}x2F). Each property reference token
...
-------------------      ----------
${symbol_pound}                        self, the root of the resource itself
${symbol_pound}/foo                    the object referred to by the foo property
${symbol_pound}/foo/another%20prop     the object referred to by the "another prop"
                         property of the object referred to by the 
                         "foo" property
${symbol_pound}/foo/another%20prop/baz the string referred to by the value of "baz"
                         property of the "another prop" property of 
                         the object referred to by the "foo" property
${symbol_pound}/foo/anArray/0          the first object in the "anArray" array
]]>
							</artwork>
						</figure>
					</t>
				...
				<section title="dot-delimited fragment resolution">
					<t>
						...
						(${symbol_escape}x2E) is used as the delimiter between property names (instead of "/") and 
						the path does not need to start with a ".". For example, ${symbol_pound}.foo and ${symbol_pound}foo are a valid fragment
...
[{
	"id": "bar",
	"name": "This representation can be safely treated ${symbol_escape}
		as authoritative "
}, {
	"id": "/baz",
	"name": "This representation should not be treated as ${symbol_escape}
		authoritative the user agent should make request the resource${symbol_escape}
		from '/baz' to ensure it has the authoritative representation"
}, {
	"id": "http://othersite.com/something",
	"name": "This representation${symbol_escape}
		should also not be treated as authoritative and the target${symbol_escape}
		resource representation should be retrieved for the${symbol_escape}
				...
				<list style="hanging">
					<t hangText="draft-03">
						<list style="symbols">
							...
							<t>Added "${symbol_dollar}ref" and "${symbol_dollar}schema" attributes.</t>
						</list>
					</t>
