...
<![CDATA[
{
	...
	"extends": {"${symbol_dollar}ref": "http://json-schema.org/draft-04/schema"}
}
]]>
						</artwork>
					</figure>
			...
			<section title="${symbol_dollar}ref" anchor="ref">
				<t>
			...
			<section title="${symbol_dollar}schema" anchor="schema">
				<t>
